      ...
      */
      ...
      document
        ...
        .addEventListener("submit", async (e) => {
          ...
          // Simulación: en producción usar POST /api/login y manejar token/session
          console.info("Login simulado", { email, pass });
          alert(
            "Inicio de sesión (simulado). Conecta con /api/login en el backend."
          );
          bootstrap.Modal.getInstance(
